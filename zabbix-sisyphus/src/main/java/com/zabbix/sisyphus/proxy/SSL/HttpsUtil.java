package com.zabbix.sisyphus.proxy.SSL;
...
import com.zabbix.sisyphus.proxy.IP;
...
public class HttpsUtil {
	...
	public static void main(String[] args) {
		String urlString = "https://www.lagou.com/jobs/positionAjax.json?px=new&needAddtionalResult=false&first=false&pn=4";
